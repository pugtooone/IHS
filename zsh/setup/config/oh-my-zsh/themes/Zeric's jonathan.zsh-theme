...
if [[ "${langinfo[CODESET]}" = UTF-8 ]]; then
  PR_SET_CHARSET=""
  PR_HBAR="─"
  PR_VBAR="|" #added by myself to put before the date
  PR_ULCORNER="┌"
  PR_LLCORNER="└"
  PR_LRCORNER="┘"
  PR_URCORNER="┐"
...
${PR_CYAN}${PR_LLCORNER}${PR_CYAN}${PR_HBAR}${PR_BLUE}(\
${PR_YELLOW}%!${PR_BLUE})${PR_CYAN}${PR_HBAR}\
${PR_BLUE}(%(?.${PR_GREEN}gogogo.${PR_RED}Error)${PR_BLUE})${PR_CYAN}${PR_HBAR}\
${PR_HBAR}${PR_BLUE}%#${PR_CYAN}${PR_HBAR}\
>${PR_NO_COLOUR} ' #End of PS1

#${PR_BLUE}(${PR_LIGHT_BLUE}%{$reset_color%}$(git_prompt_info)$(git_prompt_status)${PR_BLUE})${PR_CYAN}${PR_HBAR}\

# display exitcode on the right when > 0
return_code="%(?..%{$fg[red]%}%? ↵ %{$reset_color%})"
RPS1=' $return_code${PR_CYAN}${PR_VBAR}${PR_HBAR}${PR_CYAN}${PR_HBAR}\
${PR_BLUE}(${PR_YELLOW}%D{%a,%b%d}${PR_BLUE})${PR_CYAN}${PR_HBAR}${PR_CYAN}\
${PR_LRCORNER}${PR_NO_COLOUR}' #End of RPS1

PS2='${PR_CYAN}]${PR_HBAR}${PR_HBAR}\
${PR_BLUE}(\
${PR_LIGHT_GREEN}%_${PR_BLUE})\
${PR_CYAN}${PR_HBAR}${PR_HBAR}[${PR_NO_COLOUR} '
